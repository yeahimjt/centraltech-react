...
const Alert = ({Icon, Header, Text, alert, setAlert}) => {
  return (  
    <div className={"fixed bottom-6 right-6 flex justify-center items-center gap-4  p-6 bg-[color:var(--highlight-blue)] text-white rounded-alert animate-slideright z-30"}>
        <div>
            <Icon size={32}/>
        </div>
        <div>
